...
ledpred.obj=LedPred::ledpred(x=x, y=y, valid.times=valid.times, feature.nb.vector=feature.nb.vector, file.prefix = file.prefix.train)
...
scores = LedPred::scoreData(x, model=model, score.file = score.file)
