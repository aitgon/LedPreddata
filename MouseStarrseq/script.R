...
feature_matrix=LedPred::mapFeaturesToCRMs(URL='http://ifbprod.aitorgonzalezlab.org/map_features_to_crms.php', positive.bed='267level3.bed', negative.bed='1360level1.bed', pssm='../data/drosoVertebrateJaspar_flyFactor_hPDI.tf', background.freqs='2nt_upstream_Mus_musculus_EnsEMBL-noov-2str.freq', genome='mm9', my.values=list.files('peaks', full.names=TRUE), crm.feature.file=crm.feature.file, stderr.log.file = stderr.log.file, stdout.log.file = stdout.log.file)
